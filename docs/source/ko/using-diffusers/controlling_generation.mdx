...
## 자기 주의 안내 Self-attention Guidance (SAG)
...
사전 학습된 모델 외에도 Diffusers는 사용자가 제공한 데이터에 대해 모델을 미세 조정할 수 있는 학습 스크립트가 있습니다.

### DreamBooth

[DreamBooth](../training/dreambooth)는 모델을 미세 조정하여 새로운 주제에 대해 가르칩니다. 즉, 한 사람의 사진 몇 장을 사용하여 다양한 스타일로 그 사람의 이미지를 생성할 수 있습니다.

사용 방법에 대한 자세한 내용은 [여기](../training/dreambooth)를 참조하세요.

### 텍스트 반전

[Textual Inversion](../training/text_inversion)은 모델을 미세 조정하여 새로운 개념에 대해 학습시킵니다. 즉, 특정 스타일의 아트웍 사진 몇 장을 사용하여 해당 스타일의 이미지를 생성할 수 있습니다.
